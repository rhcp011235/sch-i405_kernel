...
static unsigned int sleep_gpio_table[][3] =
{
	...
	{S5PV210_GPB(6),  S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},	//GPIO_MSENSE_nRST_REV01
...
#if  defined(CONFIG_GPS_GSD4T_USE)
	{S5PV210_GPG3(2), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPS_PWR_EN
#else
	...
	// MP01 -------------------------------------------------
#if  defined(CONFIG_GPS_GSD4T_USE)
	{S5PV210_MP01(0), S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},	//GPS_nRST
#else
