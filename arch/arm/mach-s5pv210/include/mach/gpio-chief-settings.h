...
// {S5PV210_GPJ0(7), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},  /* CAM_FLASH_EN HW PULL_DOWN */
   ...
   {S5PV210_MP01(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* MAIN_KEY_LED_EN(NC) ~ HW Rev0.6 */
...
//	{S5PV210_GPH0(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // GYRO_INT (Active High?)
	{S5PV210_GPH0(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // GYRO_INT (Active High?)
...
//	{S5PV210_GPH3(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // VT_CAM_EN
	{S5PV210_GPH3(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},   // VT_CAM_RST
    {S5PV210_GPH3(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // VT_CAM_EN
...
//	{S5PV210_GPH3(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // GYRO_DRDY (Active High?)
	{S5PV210_GPH3(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // GYRO_DRDY (Active High?)
