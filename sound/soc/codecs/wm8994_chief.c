...
void wm8994_set_voicecall_speaker(struct snd_soc_codec *codec)
{
	...
	wm8994_write(codec, WM8994_INPUT_MIXER_3, WM8994_IN1L_TO_MIXINL |WM8994_IN1L_MIXINL_VOL);
	...
	wm8994_write(codec, WM8994_LEFT_LINE_INPUT_1_2_VOLUME, 0x0112);
